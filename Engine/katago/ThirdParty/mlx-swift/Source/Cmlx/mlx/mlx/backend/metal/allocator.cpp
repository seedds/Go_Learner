...
MetalAllocator::MetalAllocator()
  ...
  // The iOS/visionOS simulator's MTLSimDevice rejects shared-storage heaps
  // ("MTLStorageModePrivate is required for heaps"). Skip the heap so all
  // allocations go through device_->newBuffer (mirrors the is_vm path above).
  return;
#endif
